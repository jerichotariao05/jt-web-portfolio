...
import { AppWindow, Mail, Send } from "lucide-react";
    ...
    >
      <div className="flex flex-col gap-2 mb-6">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed pr-4">
          I am open to work opportunities, collaborations, and feedback. Reach
          out to discuss how I can contribute to your project.
        </p>
      </div>
      <div className="flex flex-col gap-8 p-2">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2">
            ...
            <h5 className="font-mono text-lg md:text-xl font-medium">Email</h5>
          </div>
          <p className="text-muted-foreground leading-relaxed">
            <a href="mailto:jerichotariao15@gmail.com">
              jerichotariao15@gmail.com
            </a>
          </p>
        </div>
        {/* LinkedIn */}
        <div className="flex flex-col gap-2">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            >
              Click or tap this link to view my LinkedIn profile.
            </a>
          </p>
        </div>
        {/* Github */}
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2">
            ...
            <h5 className="font-mono text-lg md:text-xl font-medium">GitHub</h5>
          </div>
          <p className="text-muted-foreground leading-relaxed">
            <a
              ...
              rel="noopener noreferrer"
            >
              Click or tap this link to view my GitHub profile.
            </a>
          </p>
        </div>
      </div>
